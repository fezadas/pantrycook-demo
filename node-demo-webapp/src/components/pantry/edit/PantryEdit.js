...
renderSuggestions() {
    ...
    return(
        <ul className="list-group">
            {suggestions.suggestions.map((item)=> <li className="list-group-item" onClick={() => this.suggestionsSelected(item.Name)}>{item.Name}</li>)}
        </ul>
    )
    ...
    if(items){    
        return (
            <div >
                ...
                <div>  
                    <form autoComplete="off" className="form-inline" onSubmit={this.handleSubmit.bind(this)}>
                        <div className="form-group mx-sm-3 mb-2">
                            ...
                            <input name="ingredient" style={form.input_style_1} value={value} onChange={this.onTextChange} className="form-control" type="text"  placeholder="Ingredient"></input>
                        ...
                        <div className="form-group mx-sm-3 mb-2">
                            ...
                            <input style={form.input_style_2} value={quantity} onChange={this.onQuantityChange} name="quantity" type="text" className="form-control" id="quantity" placeholder="Quantity"/>
                        </div>
                ...
                <div style={list.top}> 
                   <PantryListEdit ingredients={pantry.ingredients} 
